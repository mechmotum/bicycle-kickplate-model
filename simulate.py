...
def calc_nonlinear_tire_force(alpha, phi, Fz):
    ...
    ## Old simple case
    opt_Pac_fy = [
        3.11785071938867,            # MF Coefficients (14 par): Tyre Schwalbe T03, Pressure 300 kPa. For input in deg. Upper Limit Fz: 1000 N
        -752.571579481671,
        1187.69713139730,
        124.477503972100,
        0.760139546489959,
    ...
    opt_Pac_Mz = [
        2.09906592639809,    # MF Coefficients (18 par): Tyre Schwalbe T03, Pressure 300 kPa. For input in deg. Upper Limit Fz: 1000 N
        10.5876618219117,
        2.60441934159322,
        0.0623247274902716,
        -3.31585328999185,
